...
('暑期三下乡社会实践', '暑期三下乡', '前往农村开展支教、调研、志愿服务等活动，了解基层社会发展状况', '2025-07-01 08:00:00', '2025-07-15 18:00:00', '云南省大理市', 30, 5, 'recruiting'),
('企业参观实习', '企业参观', '参观科技企业，了解企业运营模式和技术发展趋势', '2025-06-15 09:00:00', '2025-06-15 17:00:00', '杭州市滨江区', 50, 4, 'recruiting'),
('社区志愿服务', '社区服务', '走进社区开展志愿服务活动，关爱老年人和儿童', '2025-05-01 08:00:00', '2025-05-30 18:00:00', '本市各社区', 100, 5, 'ongoing'),
('红色教育实践', '红色教育', '参观红色革命圣地，接受爱国主义教育', '2025-04-01 08:00:00', '2025-04-03 18:00:00', '井冈山革命根据地', 40, 4, 'finished'),
('科技创新实践', '科技创新', '参与科技创新项目，培养创新思维和实践能力', '2025-08-01 09:00:00', '2025-08-31 18:00:00', '学校创新实验室', 20, 3, 'recruiting'),
('环保公益行动', '环保公益', '开展环境保护宣传和垃圾分类实践活动', '2025-09-01 08:00:00', '2025-09-15 17:00:00', '城市公园及社区', 60, 4, 'ongoing'),
('文化遗产调研', '文化调研', '调研当地非物质文化遗产，撰写调研报告', '2025-03-01 08:00:00', '2025-03-20 18:00:00', '古城镇历史街区', 25, 5, 'finished'),
('乡村振兴调研', '乡村振兴', '深入乡村了解振兴政策实施情况和农业发展', '2025-10-01 08:00:00', '2025-10-20 18:00:00', '周边乡镇', 35, 0, 'recruiting'),
('法律援助实践', '法律援助', '为社区居民提供法律咨询和援助服务', '2025-06-01 09:00:00', '2025-06-30 17:00:00', '社区法律服务中心', 15, 0, 'ongoing')
...
(2, 1, 1, '2025-05-02 11:30:00'),
(3, 1, 0, '2025-05-03 14:20:00'),
(4, 1, 2, '2025-05-04 09:15:00'),
(5, 1, 0, '2025-05-05 16:40:00'),
-- 企业参观 (活动2)
(1, 2, 1, '2025-05-10 08:30:00'),
(3, 2, 1, '2025-05-11 09:00:00'),
(6, 2, 0, '2025-05-12 10:30:00'),
(7, 2, 1, '2025-05-13 14:00:00'),
-- 社区服务 (活动3)
(2, 3, 1, '2025-04-15 11:00:00'),
(4, 3, 1, '2025-04-16 13:30:00'),
(5, 3, 1, '2025-04-17 09:45:00'),
(8, 3, 1, '2025-04-18 10:20:00'),
(9, 3, 0, '2025-04-19 15:10:00'),
-- 红色教育 (活动4)
(1, 4, 1, '2025-03-01 08:00:00'),
(2, 4, 1, '2025-03-01 08:30:00'),
(3, 4, 1, '2025-03-02 09:00:00'),
(10, 4, 1, '2025-03-02 10:00:00'),
-- 科技创新 (活动5)
(4, 5, 1, '2025-07-01 14:30:00'),
(5, 5, 1, '2025-07-02 09:00:00'),
(6, 5, 1, '2025-07-03 11:20:00'),
-- 环保公益 (活动6)
(7, 6, 1, '2025-08-15 09:00:00'),
(8, 6, 1, '2025-08-16 10:30:00'),
(9, 6, 1, '2025-08-17 14:00:00'),
(13, 6, 1, '2025-08-18 11:00:00'),
-- 文化调研 (活动7)
(5, 7, 1, '2025-02-15 08:30:00'),
(6, 7, 1, '2025-02-16 09:00:00'),
(10, 7, 1, '2025-02-17 10:30:00'),
(11, 7, 1, '2025-02-18 11:00:00'),
(15, 7, 1, '2025-02-19 14:00:00');
...
(2, 3, '2025-05-01', '今天前往社区服务中心，帮助老人们整理房间，陪他们聊天，感受到志愿服务的意义。', 'completed', '2025-05-01 18:00:00'),
(2, 3, '2025-05-02', '组织社区儿童开展绘画活动，孩子们很开心，我也学到了如何与孩子沟通。', 'completed', '2025-05-02 17:30:00'),
(4, 3, '2025-05-01', '协助社区工作人员整理档案资料，了解了社区管理的基本流程。', 'completed', '2025-05-01 17:00:00'),
(5, 3, '2025-05-03', '参与社区环境卫生清洁工作，打扫公共区域，居民们非常感谢。', 'completed', '2025-05-03 16:30:00'),
(8, 3, '2025-05-02', '为社区独居老人送餐，了解他们的生活需求，记录反馈信息。', 'completed', '2025-05-02 12:00:00'),
(1, 4, '2025-04-01', '参观井冈山革命博物馆，深入了解革命历史，感受先烈的奉献精神。', 'completed', '2025-04-01 20:00:00'),
(1, 4, '2025-04-02', '徒步走访革命遗址，实地体验红军长征的艰辛历程。', 'completed', '2025-04-02 19:30:00'),
(2, 4, '2025-04-01', '聆听老红军后代讲述革命故事，深受触动，撰写心得体会。', 'completed', '2025-04-01 21:00:00'),
(3, 4, '2025-04-02', '参与红色主题演讲活动，分享学习心得，与同学们交流感想。', 'completed', '2025-04-02 18:00:00'),
(4, 5, '2025-07-10', '学习Python编程基础，完成第一个小程序的编写。', 'completed', '2025-07-10 20:00:00'),
(5, 5, '2025-07-10', '参与机器学习入门培训，了解算法基本原理。', 'completed', '2025-07-10 19:00:00'),
(7, 6, '2025-09-01', '在公园开展垃圾分类宣传活动，向市民发放宣传手册。', 'completed', '2025-09-01 17:00:00'),
(8, 6, '2025-09-02', '组织社区居民参与环保知识竞赛，反响热烈。', 'completed', '2025-09-02 18:30:00'),
(5, 7, '2025-03-05', '走访当地老艺人，记录传统手工艺制作流程。', 'completed', '2025-03-05 17:00:00'),
(6, 7, '2025-03-06', '拍摄非遗文化纪录片素材，采访传承人。', 'completed', '2025-03-06 18:00:00');

-- ============================================================
-- 6. 实践报告数据
-- ============================================================
INSERT IGNORE INTO `practice_report` (`student_id`, `activity_id`, `title`, `content`, `attachment`, `status`, `feedback`, `submit_time`) VALUES
(1, 4, '井冈山红色之旅感悟', '通过这次红色教育实践活动，我深刻感受到了革命先辈们的伟大精神。在井冈山革命博物馆，我看到了许多珍贵的历史文物和照片...', '/uploads/reports/student1_activity4.pdf', 'reviewed', '报告内容充实，感悟深刻，能够将理论与实践相结合。建议今后继续深入学习党史。评分：92分', '2025-04-10 14:00:00'),
(2, 4, '传承红色基因 牢记使命担当', '这次井冈山之行让我受益匪浅。通过聆听老红军后代讲述的革命故事，我深刻理解了什么是"坚定信念、艰苦奋斗"的井冈山精神...', NULL, 'reviewed', '文章立意高远，表达流畅，展现了良好的思想觉悟。期待你在今后的学习中继续保持这种积极向上的态度。评分：88分', '2025-04-11 10:30:00'),
(3, 4, '红色文化与当代青年责任', '本次红色教育实践让我对革命历史有了更深入的了解。通过实地考察和亲身体验，我认识到红色文化的重要价值...', '/uploads/reports/student3_activity4.docx', 'reviewed', '分析有深度，结构清晰，能够独立思考问题。建议加强文献引用的规范性。评分：85分', '2025-04-12 16:00:00'),
(10, 4, '革命精神的时代价值探究', '本报告以井冈山革命精神为研究对象，探讨其在新时代的价值意义...', NULL, 'pending', NULL, '2025-04-13 09:00:00'),
(5, 7, '传统手工艺的困境与出路', '通过对古城镇传统手工艺的实地调研，我发现许多珍贵的非遗技艺正面临失传的困境...', '/uploads/reports/student5_activity7.pdf', 'reviewed', '调研扎实，建议具有可操作性。报告体现了较强的问题意识和解决能力。评分：90分', '2025-03-25 11:00:00'),
(6, 7, '古建筑保护现状调查报告', '本报告聚焦于历史街区古建筑的保护现状，通过实地走访和问卷调查，收集了大量第一手资料...', '/uploads/reports/student6_activity7.pdf', 'reviewed', '数据详实，分析到位，对策建议有针对性。继续保持这种严谨的研究态度！评分：93分', '2025-03-26 14:30:00'),
(11, 7, '非物质文化遗产传承人口述史', '本报告以口述历史的形式，记录了三位非遗传承人的人生经历和技艺传承故事...', NULL, 'reviewed', '切入点新颖，记录生动感人。建议今后可以考虑制作成视频纪录片形式传播。评分：87分', '2025-03-27 10:00:00'),
(2, 3, '社区志愿服务实践总结', '本月参与社区志愿服务活动共计15天，累计服务时长超过60小时...', NULL, 'pending', NULL, '2025-05-28 16:00:00'),
(4, 3, '社区治理与志愿服务调研', '本报告结合社区志愿服务实践，对社区治理模式进行了初步探讨...', '/uploads/reports/student4_activity3.pdf', 'pending', NULL, '2025-05-29 11:00:00');
...
-- 红色教育实践 (活动4 - 李老师评分)
(1, 4, 2, 92, '表现优秀，积极参与各项活动，心得体会深刻。', '2025-04-15 10:00:00'),
(2, 4, 2, 88, '态度认真，能够主动思考，报告质量较高。', '2025-04-15 10:30:00'),
(3, 4, 2, 85, '参与度高，有独立见解，需进一步提升表达能力。', '2025-04-15 11:00:00'),
(10, 4, 2, 82, '基本完成任务，建议更加深入思考。', '2025-04-15 11:30:00'),
-- 文化遗产调研 (活动7 - 多教师评分)
-- 张老师评分
(5, 7, 1, 90, '调研认真细致，报告质量高。', '2025-03-28 14:00:00'),
(6, 7, 1, 94, '数据分析能力强，建议切实可行。', '2025-03-28 14:30:00'),
(10, 7, 1, 86, '参与积极，团队协作能力好。', '2025-03-28 15:00:00'),
(11, 7, 1, 88, '采访技巧好，记录完整。', '2025-03-28 15:30:00'),
(15, 7, 1, 84, '态度认真，需提升分析深度。', '2025-03-28 16:00:00'),
-- 李老师评分
(5, 7, 2, 88, '研究方法得当，结论有说服力。', '2025-03-29 09:00:00'),
(6, 7, 2, 92, '专业素养高，报告规范。', '2025-03-29 09:30:00'),
(10, 7, 2, 85, '基础扎实，可进一步深化。', '2025-03-29 10:00:00'),
(11, 7, 2, 86, '口述史记录生动真实。', '2025-03-29 10:30:00'),
(15, 7, 2, 83, '完成基本任务，表现中规中矩。', '2025-03-29 11:00:00'),
-- 王老师评分
(5, 7, 3, 91, '对非遗保护有独到见解。', '2025-03-30 14:00:00'),
(6, 7, 3, 95, '综合表现突出，是本次活动的优秀代表。', '2025-03-30 14:30:00'),
(10, 7, 3, 87, '团队贡献大，协调能力强。', '2025-03-30 15:00:00'),
(11, 7, 3, 89, '文字功底好，报告可读性强。', '2025-03-30 15:30:00'),
(15, 7, 3, 85, '认真负责，有进步空间。', '2025-03-30 16:00:00');

-- ============================================================
-- 8. 公告数据
-- ============================================================
INSERT IGNORE INTO `notice` (`title`, `content`, `publisher_id`, `status`, `publish_time`) VALUES
('2025年暑期社会实践活动报名通知', '各位同学：\n\n2025年暑期社会实践活动现已开始报名！本次活动包括"暑期三下乡"、"企业参观实习"等多个项目，欢迎同学们积极参与。\n\n报名截止时间：2025年6月15日\n报名方式：登录系统在线报名\n\n如有疑问，请联系学工办。', 1, 'published', '2025-05-15 09:00:00'),
('关于提交社会实践报告的通知', '各位同学：\n\n请参与已结束社会实践活动的同学于活动结束后两周内提交实践报告。报告应包含实践过程记录、心得体会、收获总结等内容。\n\n未按时提交报告者，将影响最终成绩评定。', 1, 'published', '2025-05-20 10:30:00'),
('社会实践安全须知', '各位同学：\n\n为确保社会实践活动的顺利进行，请各位同学注意以下安全事项：\n\n1. 外出实践时务必结伴而行\n2. 保持手机通讯畅通\n3. 遵守活动纪律和作息时间\n4. 注意人身财产安全\n5. 如遇紧急情况及时联系带队老师', 1, 'published', '2025-06-01 08:00:00'),
('优秀实践团队表彰通知', '经评审，以下团队被评为2025年度优秀社会实践团队：\n\n1. 红色足迹探寻队（红色教育实践）\n2. 非遗传承调研组（文化遗产调研）\n\n请获奖团队成员于本周五下午3点到学工办领取荣誉证书。', 1, 'published', '2025-04-25 14:00:00'),
('科技创新实践项目启动公告', '各位同学：\n\n2025年科技创新实践项目现已启动！本次活动聚焦人工智能、大数据等前沿技术，由计算机学院多位教授担任导师。\n\n项目时间：2025年8月1日-8月31日\n地点：学校创新实验室\n名额：20人', 1, 'published', '2025-07-01 09:00:00');

-- ============================================================
-- 9. 系统日志数据
-- ============================================================
INSERT IGNORE INTO `system_log` (`user_id`, `username`, `operation`, `method`, `params`, `ip`, `create_time`) VALUES
(1, 'admin', '用户登录', 'POST /user/login', 'username=admin', '127.0.0.1', '2025-05-01 08:30:00'),
(1, 'admin', '访问管理员首页', 'GET /index', NULL, '127.0.0.1', '2025-05-01 08:30:15'),
(1, 'admin', '发布公告', 'POST /notice/add', 'title=2025年暑期社会实践活动报名通知', '127.0.0.1', '2025-05-15 09:00:00'),
(2, 'teacher1', '用户登录', 'POST /user/login', 'username=teacher1', '192.168.1.101', '2025-05-16 09:15:00'),
(2, 'teacher1', '创建实践活动', 'POST /activity/add', 'title=暑期三下乡社会实践', '192.168.1.101', '2025-05-16 10:00:00'),
(6, 'student1', '用户登录', 'POST /user/login', 'username=student1', '192.168.1.201', '2025-05-17 14:30:00'),
(6, 'student1', '报名活动', 'POST /studentActivity/register', 'activityId=1', '192.168.1.201', '2025-05-17 14:35:00'),
(2, 'teacher1', '审核报名', 'POST /studentActivity/approve', 'id=1', '192.168.1.101', '2025-05-18 09:00:00'),
(3, 'teacher2', '评定成绩', 'POST /grade/doGrade', 'studentId=1&activityId=4&score=92', '192.168.1.102', '2025-04-15 10:00:00'),
(7, 'student2', '创建小组', 'POST /group/create', 'activityId=1&groupName=阳光支教队', '192.168.1.202', '2025-05-20 10:30:00'),
(6, 'student1', '提交实践报告', 'POST /practiceReport/submit', 'activityId=4', '192.168.1.201', '2025-04-10 14:00:00');
