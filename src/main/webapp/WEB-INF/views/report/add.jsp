...
<body>
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form action="/practiceReport/add" method="post">
                <input type="hidden" name="activityId" value="${activityId}">
                
                <div class="form-group">
                    <label for="title">报告标题:</label>
                    <input type="text" id="title" name="title" placeholder="请输入报告标题" required>
                </div>
                
                <div class="form-group">
                    <label for="content">报告内容:</label>
                    <textarea id="content" name="content" placeholder="请输入报告内容" required></textarea>
                </div>
                
                <div class="form-group">
                    <label for="attachment">附件路径（可选）:</label>
                    <input type="text" id="attachment" name="attachment" placeholder="请输入附件路径">
                </div>
