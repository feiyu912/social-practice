...
<html>
<head>
    <title>${student == null ? '添加学生' : '编辑学生'} - 学生社会实践管理系统</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="content">
        <h2 class="page-title">${student == null ? '添加学生' : '编辑学生'}</h2>
        
        <div class="form-container">
            <form action="${student == null ? '/student/add' : '/student/edit'}" method="post">
                ...
                <div class="form-group">
                    <label>性别 *</label>
                    <input type="radio" name="gender" value="男" <c:if test="${student.gender == '男' || student == null}">checked</c:if>> 男
                ...
                <div class="form-group">
                    ...
                    <textarea id="address" name="address" placeholder="请输入家庭地址">${student.address}</textarea>
                </div>
                
                <div class="form-buttons">
                    <button type="submit" class="btn-submit">${student == null ? '添加' : '保存修改'}</button>
